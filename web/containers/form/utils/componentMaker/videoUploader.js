...
import {componentVideo} from '../../const'
...
export function getNode(index){
    ...
    return(
        ...
        onContextMenu={(e)=>{
            ...
            <a href="javascript:;" className="file" style={{position:'relative',display:'inline-block',marginLeft:'5px',verticalAlign:'middle'}} className="true-form-tool-bar-component-video-btn">
                <input type="file" name="" id="" accept="video/*" onChange={this.onChange.bind(this)}/>
            </a>
        </div>
    )
}