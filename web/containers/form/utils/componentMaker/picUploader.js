...
import {componentPicture} from '../../const'
...
export default class audioUploader extends ComponentMaker{
    constructor(id,tdId,styleArr,styleId,funcArray,recoverData){
        ...
        this.type = componentPicture;
        this.value = recoverData ? recoverData.value:'';
        this.style = recoverData ? recoverData.style : {width1:180,height1:50,width:13,height:13};
...
export function getNode(index){
    ...
    return(
        ...
        onContextMenu={(e)=>{
            ...
            <a href="javascript:;" className="file" style={{position:'relative',display:'inline-block',marginLeft:'5px',verticalAlign:'middle'}} className="true-form-tool-bar-component-img-btn">
                <input type="file" name="" id="" accept="image/*" onChange={this.onChange.bind(this)}/>
            </a>
        </div>
    )
}