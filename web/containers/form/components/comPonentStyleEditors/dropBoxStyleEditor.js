...
export default class DropBoxStyleEditor extends Component{
    ...
    onConformClick(){
        ...
        const {textPicker,colorPicker,numberPicker,numberPicker1,numberPicker2,dropBoxPicker,optionDataPicker} = this.refs;
        // let cStyle = {};
        ...
        // }
        onConfirm({dataArray:optionDataPicker.getValue()},item);
        onClose();
    }
    ...
    render(){
        ...
        return(
            <div className="abc-form-component-text-style-editor-container" style={{marginTop:posInfo.pageY,marginLeft:posInfo.pageX}}>
                ...
                <OptionDataPicker ref='optionDataPicker' text={textValue} title="设置选项"/>
